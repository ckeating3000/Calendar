                        ...
                        'success' : function(data){
                            ...
                            if(json_length > 0){
                                for (var i = 0; i<json_length; i++)
                                {
                                    ...
                                    document.getElementById(daySend).innerHTML += "<div id='" + jsondata[i].id + "'>" + "<div class='event_time'>" +  jsondata[i].time + "</div>" + "<div class='event_text'>" + jsondata[i].event_text + "</div>" + "<div class='event_tag'> Tag: " + jsondata[i].event_tag + "</div>";
